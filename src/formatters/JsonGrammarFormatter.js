...
module.exports = class JsonGrammarFormatter {
   ...
   * matches the given formal syntax grammar. Else returns an objecting indicating the error message.
   *
   ...
   * @returns {Object} - a JSON grammar if the formal syntax matches the formal syntax grammar, else an error object
   *                     containing the error message under the 'error' key.
   */
   ...
   * that don't contain termainal expressions. For example, given the formal syntax "(a | b) || c", we would have
