...
function getShorthandType(syntax) {
  return Object.keys(SHORTHAND_TPYE_MAP)
      .find(shorthandType => SHORTHAND_TPYE_MAP[shorthandType].test(syntax)) || OTHER_SHORTHAND_TYPE_NAME;
}
