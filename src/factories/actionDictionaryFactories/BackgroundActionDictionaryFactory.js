  ...
  static createActionDictionary(propertyName) {
    return {
      Exp(baseNode) {
        ...
        // TODO: handle when property value lists are not of the same length
        // https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Transitions/Using_CSS_transitions#When_property_value_lists_are_of_different_lengths
        return [
